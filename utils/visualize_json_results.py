...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", help="name of the dataset", default="coco_2014_val")
    ...
    for dic in tqdm.tqdm(dicts):
        ...
        white_arr = np.ones(img.shape, dtype=np.uint8) * 255
        white_img = Image.fromarray(white_arr)
        vis = Visualizer(white_img, metadata)
