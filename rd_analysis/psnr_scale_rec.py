...
def coco_merge(quality1, quality2):
    ...
    psnrPath = '/data/gaocs/Understanding_Detection/log_psnr_rec/'
    psnrFileName = 'psnr_rec_' + str(quality1) + '_' + str(quality2) + '.log'
    ...
    compressed_path2 = r'/data/gaocs/Understanding_Detection/segm_contrast/segm_contrast_compress/' + quality1 + '_' + quality2 + '/'
    ...
    for idx in range(len(imgIds)):
        ...
        compressed_img1 = Image.open(compressed_path2 + img['file_name'][:-4]+'.jpg')
