...
def coco_merge(quality1, quality2):
    ...
    psnrFileName = 'psnr_' + str(quality1) + '_' + str(quality2) + '.log'
    ...
    for idx in range(len(imgIds)):
        ...
        merge_arr = merge_arr.astype(np.uint8)
        merge_img = Image.fromarray(merge_arr)
        merge_img.save(rec_path+img['file_name'][:-4]+'.png')
...
if __name__ == "__main__":
    quality1_all = ['40']
    quality2_all = ['16', '24', '35', '45']
    # quality2_all = ['1', '5', '10', '16', '20', '24', '35', '40', '45', '50', '55', '60', '65', '70', '80', '85', '90', '95']
